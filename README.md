...
https://github.com/lenuagebrun/Eventer

# Link to Site

https://eventer-2020.herokuapp.com/
...
Upon a succesful login you will be able to create a new event.

![Imgur Image](https://i.imgur.com/xkG113K.png)

### Map View

Upon a succesful creation of event, you will be able to see event on map.
